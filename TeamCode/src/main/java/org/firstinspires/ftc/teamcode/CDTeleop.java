...
import org.firstinspires.ftc.teamcode.CDDistanceSensor;
import org.firstinspires.ftc.teamcode.CDDriveChassis;
import org.firstinspires.ftc.teamcode.CDDuckSpinner;
import org.firstinspires.ftc.teamcode.CDElevator;
import org.firstinspires.ftc.teamcode.CDHardware;
import org.firstinspires.ftc.teamcode.CDIntake;
import org.firstinspires.ftc.teamcode.CDTurret;
...
public class CDTeleop extends LinearOpMode implements Runnable {
    ...
    public final double Duck_Max_Rev = -0.7; // Maximum REV power applied to motor
...
//            imu.startAccelerationIntegration(new Position(), new Velocity(), 1000);
           ...
           */
            ...
            // elevator watchdog
            double elevatorlockthreshold = .01;
            if ((elevatorinput > .01) && (Math.abs(elevatorposcurrent-elevatorposlast) < elevatorlockthreshold)) {
                myElevator.setElevatorPower(-elevatorinput);
            } else if ((elevatorinput < -.01) && (Math.abs(elevatorposcurrent-elevatorposlast) < elevatorlockthreshold)){
                myElevator.setElevatorPower(-elevatorinput);
            } else {
                //
