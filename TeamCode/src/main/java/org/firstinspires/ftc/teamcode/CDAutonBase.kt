...
open class CDAutonBase : LinearOpMode() {
    ...
    private lateinit var telemetryService: CDAutonTelemetry

    // Initialize chassis variable
    lateinit var myChassis: CDAutonDriveChassis
    ...
    override fun runOpMode() {
        ...
        myChassis = CDAutonDriveChassis(myHardware)
        telemetryService = CDAutonTelemetry(telemetry)

        //Send telemetry to signify robot waiting
        telemetryService.logResettingEncoders()

        // Setting the Modes, Do not need to change
        myChassis.stopAndResetEncoder()
        myChassis.runUsingEncoder()

        //Send telemetry to indicate successful Encoder reset
        telemetryService.logMotorPositions(myChassis.robotHardware.getPositions())
        telemetryService.logInitialized()
        ...
        // Use a variable to catch last location of the duck
        duckLocation =
